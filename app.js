...
const CAT_BADGE_RULES = {
  ...
  "營區": [
    ...
    { count: 3, name: "營區達人", icon: "fa-solid fa-helmet-safety" }
  ],
  "金門日常": [
    { count: 1, name: "日常初見", icon: "fa-solid fa-mug-hot" },
    { count: 2, name: "日常通",   icon: "fa-solid fa-bicycle" }
  ],
  "洋樓建築": [
    { count: 1, name: "洋樓入門", icon: "fa-solid fa-building-columns" },
    { count: 2, name: "洋樓達人", icon: "fa-solid fa-landmark" }
  ],
  "碉堡": [
    { count: 2, name: "碉堡入門", icon: "fa-solid fa-shield-halved" },
    { count: 4, name: "碉堡巡禮", icon: "fa-solid fa-shield" }
  ],
  "心戰設施": [
  ...
  "太武山": [
    ...
    { count: 2, name: "太武巡禮", icon: "fa-solid fa-person-hiking" }
  ],
  "閩南建築(古厝)": [
    { count: 1, name: "古厝入門", icon: "fa-solid fa-house-chimney" },
    { count: 2, name: "古厝達人", icon: "fa-solid fa-chess-rook" }
  ],
  "濕地": [
    { count: 1, name: "濕地初探",    icon: "fa-solid fa-water" },
    { count: 2, name: "濕地守護者", icon: "fa-solid fa-recycle" }
  ],
  "特約茶室": [
  ...
  "書院": [
    { count: 1, name: "書院初探", icon: "fa-solid fa-book-open-reader" },
  ...
  "在地美食": [
    { count: 2, name: "在地美食入門", icon: "fa-solid fa-bowl-food" },
    { count: 4, name: "在地美食饕客", icon: "fa-solid fa-utensils" }
  ],
  "在地飲品": [
  ...
  "金門名產": [
    ...
    { count: 4, name: "名產收藏家", icon: "fa-solid fa-bag-shopping" }
  ],
  "傳統點心": [
    { count: 2, name: "點心入門", icon: "fa-solid fa-cookie-bite" },
    { count: 4, name: "點心達人", icon: "fa-solid fa-cake-candles" }
  ],
  "風獅爺": [
    { count: 1, name: "風獅小行家", icon: "fa-solid fa-wind" },
    { count: 3, name: "風獅守護者", icon: "fa-solid fa-dragon" }
  ]
};
